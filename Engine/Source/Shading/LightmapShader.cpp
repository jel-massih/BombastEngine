...
bool LightmapShader::Initialize(ID3D11Device* device)
{
	bool result;

	result = InitializeShader(device, "Shaders\\LightmapVertexShader.cso", "Shaders\\LightmapPixelShader.cso");
	if (!result)
	{
		return false;
	}
...
bool LightmapShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, DirectX::XMMATRIX &world, DirectX::XMMATRIX &view, DirectX::XMMATRIX &projection, const std::vector<TextureClass*>& textures)
{
	bool result;
...
bool LightmapShader::InitializeShader(ID3D11Device* device, std::string vertexShaderPath, std::string pixelShaderPath)
{
	HRESULT result;
...
bool LightmapShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, DirectX::XMMATRIX &world, DirectX::XMMATRIX &view, DirectX::XMMATRIX &projection, const std::vector<TextureClass*>& textures)
{
	HRESULT result;
